...
config.JobType.psetName = 'UFCSCRootMaker_RAW-RECO_SingleMuonRun2018A-ZMu-PromptReco-v3.py'
...
config.Data.inputDataset = '/SingleMuon/Run2018A-ZMu-PromptReco-v3/RAW-RECO'
