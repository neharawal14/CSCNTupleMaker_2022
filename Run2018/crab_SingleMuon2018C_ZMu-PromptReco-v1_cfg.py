...
config.JobType.psetName = 'UFCSCRootMaker_RAW-RECO_SingleMuonRun2018C-ZMu-PromptReco-v1.py'
...
config.Data.inputDataset = '/SingleMuon/Run2018C-ZMu-PromptReco-v1/RAW-RECO'
