...
cscRootMaker = cms.EDAnalyzer('UFCSCRootMaker',
  ...
  wireDigiTagSrc = cms.untracked.InputTag('simMuonCSCDigis', 'MuonCSCWireDigi'),
  compDigiTagSrc = cms.untracked.InputTag('simMuonCSCDigis', 'MuonCSCComparatorDigi'),
  alctDigiTagSrc = cms.untracked.InputTag('hltMuonCSCDigis', 'MuonCSCALCTDigi'),
  clctDigiTagSrc = cms.untracked.InputTag('hltMuonCSCDigis', 'MuonCSCCLCTDigi'),
  corrlctDigiTagSrc = cms.untracked.InputTag('hltMuonCSCDigis', 'MuonCSCCorrelatedLCTDigi'),
